...
def main():
    ...
    for c in C_values:
        ...
        y_train_pred = cross_val_predict(model, X_train_tfidf, y_train, cv=5)  # Changed X_train_bow to X_train_tfidf
        ...
        print(f"\nCross-Validation Results for C={c} [LinearSVC with TF-IDF]:")  # Updated label
